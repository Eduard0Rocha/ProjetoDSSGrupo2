...
public class LogicaNegocio {
   ...
   return  carr.createSC(marca,modelo,cilindrada,potencia,fiabilidade,pac,tipoPneus);
    ...
    public boolean  removeCircuito(String cod) throws SQLException, NonExistantKey {
        return  circ.removeCircuito(cod);
    }
    public boolean  removeCamp(String cod) throws SQLException, NonExistantKey {
    ...
    public ArrayList<Jogador> getJogadoresCamp(String cod) throws SQLException, NonExistantKey {
        return camp.getJogadores(cod);
    }

    public HashMap<String, Integer> getClassificacaoC(String cod) throws SQLException, NonExistantKey {
        return camp.getClassificacaoC(cod);
    }
    public HashMap<String, Integer> getClassificacaoCH(String cod) throws SQLException, NonExistantKey {
