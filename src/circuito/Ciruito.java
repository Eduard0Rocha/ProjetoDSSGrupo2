...
public class Ciruito {
    ...
    public Ciruito(String codCicruito,int nvoltas,String nomeCircuito,String localizacao,float distancia,int DRS){
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Ciruito ciruito)) return false;
